/**
 * Lightbox module - manages image gallery modal with keyboard navigation and focus trapping.
 * Exported API: window.Lightbox with methods: init(), setData(images, captions), open(i), close(), prev(), next()
 */
